...
<div className="text"><span onclick="window.location.href='tel:+917879844442';">787-9844-442</span>
</div>
</div>
<div className="c-item"><FaEnvelope/>
<div className="text"><span onclick="location.href='mailto:admin@rcs.com';">Admin@rcs.com</span>
</div>
</div>
</div>
